...
// Using the information given below, determine the
// number of apples and oranges that land on Sam's house.

// In the diagram below:

// The red region denotes the house, where  is the start
// point, and  is the endpoint. The apple tree is to the
// left of the house, and the orange tree is to its right.
// Assume the trees are located on a single point, where
// the apple tree is at point , and the orange tree is at
// point .
